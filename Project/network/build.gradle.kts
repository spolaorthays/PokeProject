...
dependencies {
    ...
    //RxJava Adapter
    implementation(Dependencies.RxJava.RXJAVA_ADAPTER)
    implementation(Dependencies.RxJava.RXJAVA_ADAPTER_JAKE)

    testImplementation(Dependencies.MOCKK)

    //ChuckInterceptor
    implementation(Dependencies.Interceptors.CHUCK)

    //LoggingInterceptor
    implementation(Dependencies.Interceptors.LOGGING)
}